...
(function(){
    if(SQUARESPACE_PROMOTIONAL_POPUP_ONCLICK_DEBUG == undefined)
        const SQUARESPACE_PROMOTIONAL_POPUP_ONCLICK_DEBUG = false;
    if(SQUARESPACE_PROMOTIONAL_POPUP_ONCLICK_ANCHOR == undefined)
